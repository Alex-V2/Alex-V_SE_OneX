...
#define CPU_MILLIVOLTS {\
	825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1037, 1050, 1075, 1100, 1125, 1150, 1175, 1187, 1187, 1200, 1237};
...
//	CPU_DVFS("cpu_g",  4, 3, MHZ, 475, 640, 640, 860,  860, 1000, 1100,  1200, 1200, 1300, 1300, 1400, 1500, 1550, 1600),
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ, 460, 460, 550, 550,  680,  680,  680,  820,  970,  970, 1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1500, 1550),
	CPU_DVFS("cpu_g",  4, 1, MHZ, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1250, 1300, 1330, 1400, 1500, 1550),
	CPU_DVFS("cpu_g",  4, 2, MHZ, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1280, 1300, 1380, 1500, 1550),
	CPU_DVFS("cpu_g",  4, 3, MHZ, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1400, 1500, 1550), 
	/*One X-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
